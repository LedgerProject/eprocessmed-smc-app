...
import 'package:SmartConsent/Screens/FirmaEspecialista/firma_especialista.dart';
...
class FirmaPacienteBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: appBar(context, 'Patient Signature'),
                          ...
                          children: <Widget>[
                            ...
                            RaisedButton(
                              ...
                              onPressed: () {
                                ...
                                UserGenertaePdf().firmaPAciente(svg.toString());
