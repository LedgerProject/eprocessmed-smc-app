...
const respondentsCtr = {};

respondentsCtr.list = (req, res) => {
  const url = `${urlSrv}${urls.respSrv}`;
...
// respondentsCtr.getById = (req, res) => {
//   const { id } = req.params;
